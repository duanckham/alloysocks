...
#define PACKAGE_STRING "Squid Web Proxy 3.4.5"
...
#define SQUID_CONFIGURE_OPTIONS " '--prefix=/usr' '--localstatedir=/var' '--libexecdir=/lib/squid' '--srcdir=.' '--datadir=/share/squid' '--sysconfdir=/etc/squid' '--with-default-user=proxy' '--with-logdir=/var/log' '--with-pidfile=/var/run/squid.pid' --enable-ltdl-convenience"
